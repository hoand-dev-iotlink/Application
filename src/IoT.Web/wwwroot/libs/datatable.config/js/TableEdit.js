...
! function (t) {
    ...
    t.fn.Tabledit = function (e) {
        function n(e) {
            ...
            var editmode = i.find(".tabledit-edit-mode");

            var identifierHidden = "&" + editmode.parent().find('td.hidden input').serialize();
           
            var n = i.find(".tabledit-input").serialize() + "&action=" + e,
                a = d.onAjax(e, n);

            if (e != "delete") {
                n = editmode.find('.tabledit-input').serialize() + (identifierHidden == "&" ? "" : identifierHidden) + "&action=" + e;
                a = d.onAjax(e, n);
            }
                            ...
                            n.each(function () {
                                ...
                                if ("undefined" != typeof d.columns.editable[e][2]) {
                                    ...
                                    switch (d.columns.editable[e][2]) {
                                        case 'textarea':
                                            a = '<textarea class="tabledit-input ' + d.inputClass + '" name="' + d.columns.editable[e][1] + '" rows = "3" style="display: none;">' + t(this).text() + '</textarea>';
                                            break;
                                        default:
            ...
            b = {
                reset: function (e) {
                    t(e).each(function () {
                        ...
                        var n = t(this).find(".tabledit-span").text();

                        var typeofElement = e.prop('nodeName').toLowerCase();
                ...
                submit: function (e) {
                    ...
                    i !== !1 && (t(e).each(function () {
                        ...
                        switch (typeofElement) {
                            case 'textarea':
                                t(this).find(".tabledit-span").text(e.val(), u.view(this));
                                break;
                            default:
        ...
        return r.columns.identifier(), r.columns.editable(), r.columns.toolbar(), d.onDraw(), d.deleteButton && (i.on("click", "button.tabledit-delete-button", function (e) {
            ...
            console.log(t(this).parents("tr").find("td.tabledit-edit-mode"))
